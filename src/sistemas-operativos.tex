%% sistemas-operativos.tex
%% 2016/06/18
%% por FIUBA Apuntes
%% http://fiuba-apuntes.github.io/
%%
%% Apunte para la asignatura Sistemas Operativos de FIUBA.
%%
...
\begin{figure}[h]
  ...
  \includegraphics[
    width=0.66\textwidth
  ]{differences_between_processes_and_threads_1}
...
\begin{figure}[h]
  ...
  \includegraphics[
    width=0.65\textwidth
  ]{differences_between_processes_and_threads_2}
...
\begin{figure}[h]
  ...
  \includegraphics[
    width=0.7\textwidth
  ]{differences_between_processes_and_threads_3}
...
A call stack is composed of stack frames (also called activation records or
activation frames).
These are machine dependent and ABI-dependent data structures containing
...
El \emph{stack frame} usualmente incluye al menos los siguientes items
(en orden en que se encolan):
\begin{itemize}
  \item Argumentos (parámetros) pasados a la rutina (si posee alguno)
  \item Dirección de retorno a la rutina invocadora (ej. En el stack frame
  de una función \texttt{DibujarLinea}, una dirección al código de la función
  que la llamó, como puede ser \texttt{DibujarCuadrado})
...
El uso de la memoria cache no depende del programador ni del sistema operativo.
Sólo la ve el hardware (la microarquitectura).
...
fetch-decode-execute cycle, or FDX) is the basic operation cycle of a computer.
It is the process by which a computer retrieves a program instruction from
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\textwidth]{linkers_loaders_linking_1}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\textwidth]{linkers_loaders_linking_2}
...
\begin{figure}[p]
  \centering
  \includegraphics[width=0.6\textwidth]{linkers_loaders_loading_1}
...
\begin{figure}[p]
  \centering
  \includegraphics[width=0.6\textwidth]{linkers_loaders_loading_2}
...
\begin{figure}[p]
  \centering
  \includegraphics[width=0.6\textwidth]{linkers_loaders_loading_3}
  \caption{Resultado del proceso de \textit{loading} de bibliotecas}
